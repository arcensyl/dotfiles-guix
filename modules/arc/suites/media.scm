  ...
  (match-lambda
    (($ <home-mpd-configuration>
     ...
     (mixed-text-file "mpd.conf"
                      ...
                      (write-key-value-pair "port" (number->string port) " \"" "\"\n")
                      (write-key-value-pair "music_directory" music-directory " \"" "\"\n")
                      (write-key-value-pair "playlist_directory" playlist-directory " \"" "\"\n\n")
                      (write-key-value-pair "db_file" database-file " \"" "\"\n")
                      (write-key-value-pair "state_file" state-file " \"" "\"\n")
                      (write-key-value-pair "sticker_file" sticker-file " \"" "\"\n\n")
                      
                      (write-key-value-pair "follow_outside_symlinks"
                                            (boolean->yes-or-no follow-symlinks?)
                                            " \""
                                            "\"\n")

                      (write-key-value-pair "follow_inside_symlinks"
                                            (boolean->yes-or-no follow-symlinks?)
                                            " \""
                                            "\"\n")

                      (write-key-value-pair "auto_update"
                                            (boolean->yes-or-no auto-update?)
                                            " \""
                                            "\"\n")
