...
;; This file was taken from Aurtzy's Guix config, where it is called 'game-client.scm'.
;; I (Arcensyl) removed all calls to Aurtzy's helper functions as I don't have them in my config.
;; I also removed all non-Gamescope packages since I don't plan on using those.
;; Original file: https://github.com/aurtzy/guix-config/blob/master/modules/my-guix/packages/game-client.scm

(define-module (arc packages gamescope)
     ...
     (origin
       ...
       (patches
        (list
         ...
         "./patches/0001-build-add-options-to-override-subproject-paths.patch"))
